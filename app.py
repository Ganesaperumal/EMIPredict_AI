...
with tab3:
    ...
    col_a.markdown('<div class="feature-card-glass" style="--card-bg: rgba(239, 246, 255, 0.6);"><strong>🎯 Optimized Parquet</strong><br>Native support for Apache Parquet.</div>', unsafe_allow_html=True)
    col_b.markdown('<div class="feature-card-glass" style="--card-bg: rgba(240, 253, 244, 0.6);"><strong>🏆 Model Metrics</strong><br>Live MLflow tracking.</div>', unsafe_allow_html=True)
    col_c.markdown('<div class="feature-card-glass" style="--card-bg: rgba(254, 252, 232, 0.6);"><strong>🔍 Deep Insights</strong><br>Advanced EDA.</div>', unsafe_allow_html=True)

with tab4:
    st.write("### 🛡️ Security & Integrity")
    st.write("Your financial data is protected with local-first security measures.")
    st.success("✅ Local-First Processing | ✅ Privacy Preserved")
